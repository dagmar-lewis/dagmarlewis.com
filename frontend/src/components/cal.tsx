...
export function ScheduleCallPopup() {
  ...
  return (
    <Button
      ...
      data-cal-link="dagmar-lewis-bvnajy"
...
export function ScheduleCallFloat() {
  ...
  return (
    <Button
      ...
      data-cal-link="dagmar-lewis-bvnajy"
      data-cal-config='{"layout":"month_view"}'
      className="hidden md:flex group/cal fixed z-50 bottom-5 right-5 w-12 h-12 rounded-full hover:px-4 hover:w-auto p-2 duration-300 transition-all ease-out"
    >
      <div className="flex items-center gap-2">
        <p className="group-hover/cal:block hidden duration-300 transition-all ease-out">Book a meeting</p>
