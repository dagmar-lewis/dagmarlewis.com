export const profesHighlights = [
  ...
  {
    highlight: "Hybrid Infrastructure Management",
    task: [
    "Designed and maintained virtual environments on Proxmox and VMware, ensuring seamless integration with AWS workloads and consistent security posture"
    ],
  },{
